...
you should place your code here."
  ...
  ;; new way, implemented in spacemacs, works globally
  ...
  ;; old way, before spacemacs implementation was available, has to be defined for every mode, dont use
  ;;(spacemacs/add-to-hooks 'spacemacs/toggle-truncate-lines-off '(prog-mode-hook text-mode-hook))
  ...
  ;;(spacemacs/toggle-fill-column-indicator) ;; doesnt work, debug further why
